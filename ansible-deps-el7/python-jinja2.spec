...
%changelog
* Mon Jan  7 2019 Ondrej Famera <ondrej-xa2iel8u@famera.cz> - 2.9.6-1
- bump to version 2.9.6
- remove CVE patch that is already upstream
- remove other patch that prevents build from working
- remove tests section as there are no tests
- remove file specific to python3 as this will be build only for python2
- make dependent on python-markupsafe 0.23 or newer
